 ...
 */
class getTestResultsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TestResultsRepository' shared autowired service.
     *
     * @return \App\Repository\TestResultsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TestResultsRepository.php';

        return $container->privates['App\\Repository\\TestResultsRepository'] = new \App\Repository\TestResultsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
