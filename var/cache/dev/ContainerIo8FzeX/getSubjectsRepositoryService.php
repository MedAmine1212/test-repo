 ...
 */
class getSubjectsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SubjectsRepository' shared autowired service.
     *
     * @return \App\Repository\SubjectsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SubjectsRepository.php';

        return $container->privates['App\\Repository\\SubjectsRepository'] = new \App\Repository\SubjectsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
