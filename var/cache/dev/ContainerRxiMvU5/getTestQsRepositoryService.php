 ...
 */
class getTestQsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TestQsRepository' shared autowired service.
     *
     * @return \App\Repository\TestQsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TestQsRepository.php';

        return $container->privates['App\\Repository\\TestQsRepository'] = new \App\Repository\TestQsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
