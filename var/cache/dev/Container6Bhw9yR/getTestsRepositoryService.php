...
class getTestsRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Repository\\TestsRepository'])) {
            return $container->privates['App\\Repository\\TestsRepository'];
        }

        return $container->privates['App\\Repository\\TestsRepository'] = new \App\Repository\TestsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()), $a);
    }
}
