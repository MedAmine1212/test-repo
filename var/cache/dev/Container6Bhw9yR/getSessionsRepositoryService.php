 ...
 */
class getSessionsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SessionsRepository' shared autowired service.
     *
     * @return \App\Repository\SessionsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SessionsRepository.php';

        return $container->privates['App\\Repository\\SessionsRepository'] = new \App\Repository\SessionsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
